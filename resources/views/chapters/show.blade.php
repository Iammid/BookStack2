    ...
    <main class="content-wrap card">
        ...
        <div refs="entity-search@contentView" class="chapter-content">
            <div class="text-muted break-text">{!! $chapter->descriptionHtml() !!}</div>
                        ...
                        {{-- Display Child Chapters --}}
@if($childChapters->count() > 0)
    <h2>{{ trans_choice('entities.subchapters', $childChapters->count()) }}</h2>
    <div class="entity-list book-contents">
        @foreach($childChapters as $childChapter)
            @include('chapters.parts.list-item', ['chapter' => $childChapter])
        @endforeach
    </div>
@endif
            ...
            @if($pages->isEmpty() && $childChapters->isEmpty())
                <div class="mt-xl">
                    <hr>
                    ...
                    <div class="icon-list block inline">
                        ...
                        @endif
                        @if(userCan('chapter-create', $chapter))
                            <a href="{{ $chapter->getUrl('/create-chapter') }}" class="icon-list-item text-chapter">
