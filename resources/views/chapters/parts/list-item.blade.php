<a href="{{ $chapter->getUrl() }}" class="chapter entity-list-item @if($chapter->visible_pages && $chapter->visible_pages->count() > 0) has-children @endif" data-entity-type="chapter" data-entity-id="{{$chapter->id}}">
...
@if ($chapter->visible_pages && $chapter->visible_pages->count() > 0)
