...
Route::middleware('auth')->group(function () {
    ...
    // Sub-chapters
    Route::get('/books/{bookSlug}/create-chapter', [EntityControllers\ChapterController::class, 'create'])->name('chapters.createTopLevel');
    Route::post('/books/{bookSlug}/create-chapter', [EntityControllers\ChapterController::class, 'store'])->name('chapters.storeTopLevel');
    
    Route::get('/books/{bookSlug}/chapter/{parentChapterSlug}/create-chapter', [EntityControllers\ChapterController::class, 'create'])->name('chapters.createSub');
    Route::post('/books/{bookSlug}/chapter/{parentChapterSlug}/create-chapter', [EntityControllers\ChapterController::class, 'store'])->name('chapters.storeSub');
    // User Profile routes
